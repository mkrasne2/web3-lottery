...
const Rules = () => {
  ...
  return (
      ...
      <div className="container">
        ...
        Polygonscan using the following link: <a className = "etherscan" href="https://mumbai.polygonscan.com/address/0xbD267D6a45eFD258D598bF8fFb2fDfbA3676468B#code" target="_blank">Contract</a>
        </p>
